...
reduced_data["df_gps_tracker"] = undersample(reduced_data["df_gps_tracker"], 'type')
...
# %%
# Separate features and target for "df_gps_tracker"
X_all = reduced_data["df_gps_tracker"].drop(list(one_hot.get_feature_names_out(['type'])), axis=1)
y_all = reduced_data["df_gps_tracker"][list(one_hot.get_feature_names_out(['type']))]
