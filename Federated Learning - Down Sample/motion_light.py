...
reduced_data["df_motion_light"] = undersample(reduced_data["df_motion_light"], 'type')
...
# %%
# Separate features and target for "df_motion_light"
X_all = reduced_data["df_motion_light"].drop(list(one_hot.get_feature_names_out(['type'])), axis=1)
y_all = reduced_data["df_motion_light"][list(one_hot.get_feature_names_out(['type']))]
