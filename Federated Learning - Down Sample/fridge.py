...
reduced_data["df_fridge"] = undersample(reduced_data["df_fridge"], 'type')
...
# %%
# Separate features and target for "df_fridge"
X_all = reduced_data["df_fridge"].drop(list(one_hot.get_feature_names_out(['type'])), axis=1)
y_all = reduced_data["df_fridge"][list(one_hot.get_feature_names_out(['type']))]
