...
reduced_data["df_weather"] = undersample(reduced_data["df_weather"], 'type')
...
# %%
# Separate features and target for "df_weather"
X_all = reduced_data["df_weather"].drop(list(one_hot.get_feature_names_out(['type'])), axis=1)
y_all = reduced_data["df_weather"][list(one_hot.get_feature_names_out(['type']))]
