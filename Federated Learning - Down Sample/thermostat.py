...
reduced_data["df_thermostat"] = undersample(reduced_data["df_thermostat"], 'type')
...
# %%
# Separate features and target for "df_thermostat"
X_all = reduced_data["df_thermostat"].drop(list(one_hot.get_feature_names_out(['type'])), axis=1)
y_all = reduced_data["df_thermostat"][list(one_hot.get_feature_names_out(['type']))]
