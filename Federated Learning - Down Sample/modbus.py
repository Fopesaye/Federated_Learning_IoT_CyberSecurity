...
reduced_data["df_modbus"] = undersample(reduced_data["df_modbus"], 'type')
...
# %%
# Separate features and target for "df_modbus"
X_all = reduced_data["df_modbus"].drop(list(one_hot.get_feature_names_out(['type'])), axis=1)
y_all = reduced_data["df_modbus"][list(one_hot.get_feature_names_out(['type']))]
